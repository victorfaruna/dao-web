...
>
	...
	>
		...
		<p
			class="tetg text-[1.5rem] md:text-[0.8rem] text-color-1 font-normal font-unbounded leading-none md:text-center"
		>
		...
		<p class="tetg text-color-1/70 text-[0.7rem] md:text-[0.7rem] md:text-center font-light">
