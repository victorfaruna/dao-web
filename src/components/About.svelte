...
>
	...
	<div class="right w-[60%] md:w-full flex flex-col gap-5">
		<p class="text-color-1 text-[3rem] md:text-[2rem] text-orange-300 font-bold">
			About <img
				class={`dx inline w-[100px] ${isInView ? 'translate-x-0 transition-all duration-[1s]' : 'translate-x-[100px]'}`}
				src="/images/coooo.svg"
				alt=""
			/> <br /><span class="text-[2.5rem]">Joji Dao</span>
		</p>
		<p
