	...
	<div class="top flex gap-[5%] md:flex-col md:gap-10">
		<div class="category flex flex-col gap-2">
			...
			<p class="text">
				...
				IRL events and online community development.
			</p>
		</div>
		...
		<div class="category flex flex-col gap-2">
			...
			<p class="text">Join our Newsletter to get the latest updates from us.</p>
		</div>
	</div>
...
<style>
	...
	.title {
		@apply text-[1rem] mb-2;
	}

	.text {
		@apply text-[0.7rem] text-color-1/60;
	}
</style>
